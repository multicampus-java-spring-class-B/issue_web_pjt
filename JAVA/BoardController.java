...
public class BoardController {
	...
	public ModelAndView view(@RequestParam("title") String title) {

		ModelAndView mav = new ModelAndView();
		mav.addObject("boardlists", service.getPost(title));
	...
	public ModelAndView modify(@RequestParam("title") String title) {
		ModelAndView mav = new ModelAndView();
		mav.addObject("boardlists", service.getPost(title));
	...
	public String update(@ModelAttribute("boardlist") BoardListVO vo) {
